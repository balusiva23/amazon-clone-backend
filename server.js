...
const stripe = require("stripe")(
  "sk_test_51M7c9PGLSZnmLVUbmgdjlYj7pLTaV0uieGBeFze5FmqYtlabIXvRS4JzVJClyjfMWfk4F8HSbEcTGvYal90WdlLn00C69ubwgQ"
);
...
const connection_url =
  "mongodb+srv://balusiva1299:Siva2312@cluster0.avjoegu.mongodb.net/amazon-clone?retryWrites=true&w=majority";
...
app.post("/products/add", async (req, res) => {
  try {
    ...
    const createdProducts = await Products.insertMany(productDetailsArray);
...
app.post("/orders/get", (req, res) => {
  const email = req.body.email;
 // console.log(email);
  // Assuming you have a mongoose Orders model defined
